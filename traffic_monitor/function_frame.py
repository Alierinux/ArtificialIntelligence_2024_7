...
from traffic_monitor.UI.function_page import Ui_Dialog
from traffic_monitor.monitor_frame import Monitor
from traffic_monitor.classify_frame import Classify
from traffic_monitor.warning_frame import Warning
from traffic_monitor.record_frame import Record

class FunctionDialog(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.set_background()
        self.ui = Ui_Dialog()
    ...
    def monitor(self):
        self.monitor_dialog = Monitor()
        self.monitor_dialog.show()

    def classify(self):
        self.classify_dialog = Classify()
        self.classify_dialog.show()

    def warning(self):
        self.warning_dialog = Warning()
        self.warning_dialog.show()

    def record(self):
        self.record_dialog = Record()
